...
#     return [
#         {"id": 10, "title": "Поездка в Питер", "description": "Расходы на выходные", "created_at": datetime.utcnow()},
#         {"id": 11, "title": "Наша квартира", "description": "Совместное проживание", "created_at": datetime.utcnow()}
#     ]
